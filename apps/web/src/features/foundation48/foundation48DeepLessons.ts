...
const seeds: Record<number, DaySeed> = {
  1: {
    ...
    choices: [['Chọn câu đúng cho “Tôi là học sinh.”', 'I am a student.', ['I is a student.', 'I are a student.', 'I am student not.']], ['Chọn câu phủ định đúng.', 'He is not tall.', ['He not is tall.', 'He are not tall.', 'He am not tall.']], ['They đi với động từ nào?', 'are', ['am', 'is', 'not']]],
  ...
  3: {
    ...
    goal: 'Dùng Who để hỏi người, What để hỏi tên/đồ vật/sự việc.',
    grammarTitle: 'Who/What + is/are',
    grammar: 'Who hỏi người. What hỏi đồ vật, tên hoặc bản chất. Sau Who/What thường dùng is/are tùy chủ ngữ.',
    vocabulary: [['who', 'ai', 'Who is she?'], ['what', 'cái gì/là gì', 'What is this?'], ['name', 'tên', 'What is your name?'], ['this', 'cái này', 'What is this?'], ['that', 'cái kia', 'What is that?'], ['these', 'những cái này', 'What are these?'], ['father', 'bố', 'Who is he?'], ['mother', 'mẹ', 'Who is she?'], ['apple', 'quả táo', 'It is an apple.']],
    patterns: [['Who is + person?', 'Hỏi một người là ai', ['Who is she?', 'Who is your teacher?']], ['What is + thing?', 'Hỏi đồ vật/sự việc', ['What is this?', 'What is your name?']], ['Who/What are + plural?', 'Hỏi số nhiều', ['Who are they?', 'What are these?']]],
    sentences: [['Who is she?', 'Cô ấy là ai?'], ['She is my sister.', 'Cô ấy là chị/em gái tôi.'], ['What is this?', 'Đây là cái gì?'], ['It is a book.', 'Nó là một quyển sách.'], ['Who are they?', 'Họ là ai?']],
    fills: [['___ is she?', 'Who', 'Hỏi người dùng Who.'], ['___ is this?', 'What', 'Hỏi đồ vật dùng What.'], ['What ___ your name?', 'is', 'Name là số ít nên dùng is.']],
    orders: [['Cô ấy là ai?', 'Who is she?'], ['Đây là cái gì?', 'What is this?']],
    choices: [['Hỏi “Cô ấy là ai?”', 'Who is she?', ['What is she?', 'Who are she?', 'What are she?']], ['Hỏi “Đây là cái gì?”', 'What is this?', ['Who is this?', 'What are this?', 'This is what?']], ['Who dùng để hỏi gì?', 'người', ['đồ vật', 'thời gian', 'địa điểm']]],
    finalPrompt: 'Nói lại một câu hỏi với Who hoặc What.',
  },
  4: {
    title: 'Ở đâu, khi nào? — hỏi Where / When với to be',
    goal: 'Biết hỏi địa điểm bằng Where và thời gian bằng When trong câu ngắn.',
    grammarTitle: 'Where/When + is/are + subject',
    grammar: 'Where hỏi “ở đâu”. When hỏi “khi nào”. Với to be, dùng Where/When + is/are + chủ ngữ.',
    vocabulary: [['where', 'ở đâu', 'Where is your book?'], ['when', 'khi nào', 'When is your class?'], ['school', 'trường học', 'They are at school.'], ['home', 'nhà', 'We are at home.'], ['table', 'cái bàn', 'It is on the table.'], ['bag', 'cặp/túi', 'My pen is in the bag.'], ['Monday', 'thứ Hai', 'My test is on Monday.'], ['birthday', 'sinh nhật', 'When is your birthday?']],
    patterns: [['Where is/are + subject?', 'Hỏi địa điểm', ['Where is your book?', 'Where are they?']], ['When is/are + subject?', 'Hỏi thời gian', ['When is your birthday?', 'When are your classes?']], ['Subject + is/are + place/time', 'Trả lời địa điểm/thời gian', ['It is on the table.', 'My class is on Monday.']]],
    sentences: [['Where is your book?', 'Sách của bạn ở đâu?'], ['It is on the table.', 'Nó ở trên bàn.'], ['Where are they?', 'Họ đang ở đâu?'], ['They are at school.', 'Họ đang ở trường.'], ['When is your English class?', 'Khi nào là lớp tiếng Anh của bạn?']],
    fills: [['Where ___ your pen?', 'is', 'Pen là số ít nên dùng is.'], ['When ___ your classes?', 'are', 'Classes là số nhiều nên dùng are.'], ['They ___ at home.', 'are', 'They đi với are.']],
    orders: [['Sách của bạn ở đâu?', 'Where is your book?'], ['Họ đang ở trường.', 'They are at school.']],
    choices: [['Hỏi địa điểm dùng từ nào?', 'Where', ['When', 'Who', 'What']], ['Hỏi thời gian dùng từ nào?', 'When', ['Where', 'Who', 'What']], ['Câu đúng là gì?', 'Where is your pen?', ['Where are your pen?', 'Where your pen is?', 'When is your pen?']]],
    finalPrompt: 'Nói lại một câu hỏi với Where hoặc When.',
  },
  5: {
    title: 'Tôi làm mỗi ngày — động từ thường hiện tại',
    goal: 'Nói thói quen đơn giản bằng động từ thường và biết thêm s/es với he/she/it.',
    grammarTitle: 'Hiện tại đơn khẳng định với động từ thường',
    grammar: 'I/you/we/they dùng động từ nguyên mẫu. He/she/it thường thêm s/es ở động từ.',
    vocabulary: [['study', 'học', 'I study English.'], ['read', 'đọc', 'She reads books.'], ['play', 'chơi', 'They play football.'], ['work', 'làm việc', 'My father works.'], ['go', 'đi', 'He goes to school.'], ['like', 'thích', 'I like apples.'], ['eat', 'ăn', 'I eat breakfast.'], ['every day', 'mỗi ngày', 'We study every day.'], ['usually', 'thường xuyên', 'She usually reads.']],
    patterns: [['I/You/We/They + verb', 'Nói hành động với chủ ngữ thường', ['I study English.', 'They play football.']], ['He/She/It + verb-s/es', 'Thêm s/es với he/she/it', ['She reads books.', 'He goes to school.']], ['Subject + usually/every day + verb', 'Nói thói quen', ['I usually eat breakfast.', 'We study every day.']]],
    sentences: [['I study English.', 'Tôi học tiếng Anh.'], ['She reads books.', 'Cô ấy đọc sách.'], ['They play football.', 'Họ chơi bóng đá.'], ['He goes to school.', 'Anh ấy đi học.'], ['We study every day.', 'Chúng tôi học mỗi ngày.']],
    fills: [['He ___ to school.', 'goes', 'He nên động từ go thêm es.'], ['I ___ English.', 'study', 'I dùng động từ nguyên mẫu.'], ['She ___ books.', 'reads', 'She nên read thêm s.']],
    orders: [['Tôi học tiếng Anh.', 'I study English.'], ['Cô ấy đọc sách.', 'She reads books.']],
    choices: [['Chọn câu đúng.', 'She reads books.', ['She read books.', 'She reading books.', 'She are read books.']], ['I đi với dạng nào?', 'study', ['studies', 'studys', 'studying']], ['He + go thành gì?', 'goes', ['go', 'gos', 'going']]],
    finalPrompt: 'Nói lại một câu về việc bạn làm mỗi ngày.',
  },
  6: {
    title: 'Tôi không làm — phủ định với don’t / doesn’t',
    goal: 'Nói điều mình không làm bằng don’t và doesn’t, không thêm s sau doesn’t.',
    grammarTitle: 'do not / does not + động từ nguyên mẫu',
    grammar: 'I/you/we/they dùng don’t. He/she/it dùng doesn’t. Sau don’t/doesn’t, động từ chính luôn ở dạng nguyên mẫu.',
    vocabulary: [['do not', 'không', 'I do not like coffee.'], ['don’t', 'không (rút gọn)', 'They don’t live here.'], ['does not', 'không với he/she/it', 'She does not play tennis.'], ['doesn’t', 'không (rút gọn)', 'He doesn’t go to school.'], ['coffee', 'cà phê', 'I don’t like coffee.'], ['tennis', 'quần vợt', 'She doesn’t play tennis.'], ['Sunday', 'Chủ nhật', 'He doesn’t work on Sunday.'], ['watch', 'xem', 'I don’t watch TV every day.']],
    patterns: [['I/You/We/They + don’t + verb', 'Phủ định với chủ ngữ thường', ['I don’t like coffee.', 'They don’t live here.']], ['He/She/It + doesn’t + verb', 'Phủ định với he/she/it', ['She doesn’t play tennis.', 'He doesn’t go on Sunday.']], ['Doesn’t + verb nguyên mẫu', 'Không thêm s sau doesn’t', ['He doesn’t like tea.', 'She doesn’t read comics.']]],
    sentences: [['I do not like coffee.', 'Tôi không thích cà phê.'], ['She does not play tennis.', 'Cô ấy không chơi quần vợt.'], ['They don’t live here.', 'Họ không sống ở đây.'], ['He doesn’t go to school on Sunday.', 'Anh ấy không đi học vào Chủ nhật.'], ['We don’t watch TV every day.', 'Chúng tôi không xem TV mỗi ngày.']],
    fills: [['I ___ like coffee.', 'don’t', 'I dùng don’t để phủ định.'], ['He ___ play football.', 'doesn’t', 'He dùng doesn’t.'], ['She doesn’t ___ tea.', 'like', 'Sau doesn’t dùng động từ nguyên mẫu.']],
    orders: [['Tôi không thích cà phê.', 'I don’t like coffee.'], ['Cô ấy không chơi quần vợt.', 'She doesn’t play tennis.']],
    choices: [['Câu đúng là gì?', 'He doesn’t like tea.', ['He doesn’t likes tea.', 'He don’t like tea.', 'He not like tea.']], ['They dùng phủ định nào?', 'don’t', ['doesn’t', 'isn’t', 'aren’t']], ['Sau doesn’t dùng gì?', 'động từ nguyên mẫu', ['động từ thêm s', 'to be', 'danh từ số nhiều']]],
    finalPrompt: 'Nói lại một câu về điều bạn không làm mỗi ngày.',
  },
  7: {
    title: 'Bạn có làm không? — câu hỏi Do / Does',
    goal: 'Đặt câu hỏi thói quen bằng Do/Does và trả lời ngắn tự nhiên.',
    grammarTitle: 'Do/Does + subject + verb?',
    grammar: 'Câu hỏi hiện tại đơn với động từ thường dùng Do/Does ở đầu. He/she/it dùng Does và động từ chính không thêm s.',
    vocabulary: [['do you', 'bạn có...không', 'Do you study English?'], ['does she', 'cô ấy có...không', 'Does she like music?'], ['speak', 'nói', 'Do you speak English?'], ['music', 'âm nhạc', 'Does she like music?'], ['live', 'sống', 'Do they live here?'], ['read books', 'đọc sách', 'Do you read books?'], ['answer', 'trả lời', 'Yes, I do.'], ['question', 'câu hỏi', 'Ask a question.']],
    patterns: [['Do + I/you/we/they + verb?', 'Hỏi với do', ['Do you study English?', 'Do they live here?']], ['Does + he/she/it + verb?', 'Hỏi với does', ['Does she like music?', 'Does he play football?']], ['Yes/No + subject + do/does', 'Trả lời ngắn', ['Yes, I do.', 'No, he doesn’t.']]],
    sentences: [['Do you study English?', 'Bạn có học tiếng Anh không?'], ['Does she like music?', 'Cô ấy có thích nhạc không?'], ['Do they live here?', 'Họ có sống ở đây không?'], ['Yes, I do.', 'Vâng, có.'], ['No, he doesn’t.', 'Không, anh ấy không.']],
    fills: [['___ you speak English?', 'Do', 'You dùng Do.'], ['___ she go to school?', 'Does', 'She dùng Does.'], ['No, I ___.', 'don’t', 'Trả lời phủ định với I dùng don’t.']],
    orders: [['Bạn có học tiếng Anh không?', 'Do you study English?'], ['Cô ấy có thích nhạc không?', 'Does she like music?']],
    choices: [['Câu hỏi đúng là gì?', 'Does she like music?', ['Does she likes music?', 'Do she like music?', 'She does like music?']], ['Do you read books? trả lời ngắn đúng:', 'Yes, I do.', ['Yes, I does.', 'Yes, do I.', 'Yes, I am.']], ['Does đi với chủ ngữ nào?', 'he/she/it', ['I/you/we', 'they', 'you only']]],
    finalPrompt: 'Nói lại một câu hỏi Do hoặc Does.',
  },
  8: {
    ...
    grammar: 'Hiện tại đơn dùng cho thói quen, lịch trình và sự thật. Trạng từ như always/usually/often đứng trước động từ thường.',
    ...
    fills: [['The sun ___ in the East.', 'rises', 'Sự thật với chủ ngữ số ít thêm s.'], ['She usually ___ breakfast.', 'has', 'She dùng has.'], ['Does he ___ novels?', 'read', 'Sau Does dùng động từ nguyên mẫu.']],
  ...
  10: {
    ...
    patterns: [['I am + V-ing', 'Tôi đang làm gì', ['I am studying now.', 'I am reading.']], ['He/She/It is + V-ing', 'Một người/vật đang làm gì', ['She is cooking.', 'The baby is sleeping.']], ['We/They/You are + V-ing', 'Nhiều người/bạn đang làm gì', ['They are playing.', 'We are watching TV.']]],
  ...
  11: {
    title: 'Mỗi ngày hay ngay bây giờ? — phân biệt simple/present continuous',
