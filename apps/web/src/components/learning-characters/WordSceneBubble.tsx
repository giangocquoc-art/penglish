  ...
  return (
    ...
    >
      ...
      <VStack align="start" gap={compact ? '1.5' : '2'} position="relative">
        ...
        {pronunciationHintVi ? (
          <HStack color={BUBBLE_COLORS.deepBlue} fontSize="xs" fontWeight="800" gap="1.5" align="start">
            <Icon as={Headphones} boxSize="4" mt="0.5" flexShrink={0} aria-hidden="true" />
            <Text>{pronunciationHintVi}</Text>
          </HStack>
        ) : null}
