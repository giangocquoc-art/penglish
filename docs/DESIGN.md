...
This is the highest-priority product/design rule file for P-English.

Before changing UI, learning flow, Shadowing, Vocabulary, English Speed, Learning Path, Practice, dashboard, or shared components, every AI coding agent must read and follow this file.
...
- letter-by-letter text wrapping
...
The whale:
- must follow the current P-English whale/logo style
...
Vocabulary must feel like a learning module, not just a table.
