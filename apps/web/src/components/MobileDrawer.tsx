...
const NAV: NavItem[] = [
  { label: 'Học hôm nay', to: '/luyen-tieng-anh/48-ngay-lay-goc', icon: Waves, tint: NAV_OCEAN.whaleBlue },
  { label: 'Lộ trình', to: '/learning-path', icon: Route, tint: NAV_OCEAN.oceanBlue },
  { label: 'Shadowing', to: '/shadowing', icon: Mic, tint: NAV_OCEAN.oceanBlue },
  { label: 'Speaking', to: '/speaking-coach', icon: MessagesSquare, tint: NAV_OCEAN.oceanBlue },
  { label: 'Ôn tập', to: '/practice', icon: Dumbbell, tint: NAV_OCEAN.deepBlue },
  { label: 'Trò chơi', to: '/games', icon: Gamepad2, tint: NAV_OCEAN.whaleBlue },
