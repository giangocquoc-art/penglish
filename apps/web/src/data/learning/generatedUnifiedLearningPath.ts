...
export const generatedUnifiedLearningPath: UnifiedLearningUnit[] = [
  ...
  },
  {
    ...
    whaleCoachLine: 'Nghe ý chính trước, sau đó mới nhìn transcript để Poo bơi đúng nhịp.',
    ...
    maturityNoteVi: 'Hai bài nghe A1 gốc của P-English có transcript, câu hỏi, giải thích và nhiệm vụ ôn tập.',
    sourceModuleReference: {
      module: 'handcrafted-lessons',
