...
export const pEnglishLessons: EnglishLesson[] = [
  ...
  },
  {
    ...
    speakingReflexPrompts: [
      ...
      { id: 'u2-reflex-do-you-have-brother', promptVi: 'Hỏi: Bạn có anh/em trai không?', expectedEnglish: 'Do you have a brother?', acceptableAnswers: ['Do you have a brother?'], hint: 'Dùng cụm Do you have...', difficulty: 'medium' },
    ],
