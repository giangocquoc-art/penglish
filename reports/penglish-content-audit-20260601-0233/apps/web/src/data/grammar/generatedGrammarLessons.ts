...
export const generatedGrammarLessonSources: GeneratedGrammarLessonSource[] = ([
  ...
  },
  {
    ...
    titleVi: 'Câu điều kiện để đưa lời khuyên thực tế',
    titleEn: 'Conditionals for realistic advice',
    subtitleVi: 'Dùng if + hiện tại, will/can/should để nói kết quả hoặc lời khuyên có thể xảy ra.',
    level: 'B2',
    estimatedTime: '14–16 phút',
    sourcePatternTitle: 'Clauses: first conditional advice',
    sourcePatternDescription: 'Complete realistic if-clauses and result clauses.',
    sourcePatternSummary: 'Pattern che if-clause/result modal để luyện điều kiện thực tế và lời khuyên hành động.',
    vietnameseExplanation: 'Trong điều kiện có khả năng xảy ra, mệnh đề if dùng hiện tại đơn; mệnh đề chính có thể dùng will/can/should + động từ nguyên mẫu.',
    examples: [
      { text: 'If you practise daily, you will speak more clearly.', meaningVi: 'Nếu bạn luyện hằng ngày, bạn sẽ nói rõ hơn.' },
      { text: 'If the task feels hard, you can split it into steps.', meaningVi: 'Nếu nhiệm vụ thấy khó, bạn có thể chia thành các bước.' },
      { text: 'If you miss a word, you should repeat the sentence slowly.', meaningVi: 'Nếu bạn bỏ sót một từ, bạn nên lặp lại câu chậm rãi.' },
    ],
    exercises: [
      { id: 'conditional-advice-mc-daily', type: 'multiple-choice', promptVi: 'Chọn câu điều kiện tự nhiên nhất.', options: ['If you practise daily, you will speak more clearly.', 'If you will practise daily, you speak more clearly.', 'If you practised yesterday, you will tomorrow.', 'If daily practise, speak clear.'], answer: 'If you practise daily, you will speak more clearly.', hintVi: 'Sau if dùng hiện tại đơn.', explanationVi: 'First conditional dùng If + present simple, will + verb.' },
      { id: 'conditional-advice-fill-split', type: 'fill-blank', promptVi: 'Điền modal phù hợp.', promptEn: 'If the task feels hard, you ___ split it into steps.', answer: 'can', hintVi: 'can = có thể.', explanationVi: 'can đưa ra khả năng/giải pháp thực tế trong mệnh đề chính.' },
      { id: 'conditional-advice-order-repeat', type: 'sentence-order', promptVi: 'Sắp xếp: Nếu bạn bỏ sót một từ, bạn nên lặp lại câu chậm rãi.', words: ['If', 'you', 'miss', 'a', 'word', 'you', 'should', 'repeat', 'the', 'sentence', 'slowly'], answer: 'If you miss a word you should repeat the sentence slowly', hintVi: 'Mệnh đề if đứng trước, lời khuyên đứng sau.', explanationVi: 'should + repeat dùng để đưa lời khuyên sau điều kiện.' },
    ],
    source: { ...fluentcardsSource, sourcePatternId: 'first-conditional-advice' },
  },
