...
export const generatedUnifiedLearningPath: UnifiedLearningUnit[] = [
  {
    ...
    sourceModuleReference: {
      ...
      ids: ['unit-1-greetings-introduction', 'cefr-a1-core'],
  ...
  },
  {
    ...
    sourceModuleReference: {
      module: 'handcrafted-lessons',
      ids: ['unit-2-family-and-friends', 'unit-3-school-and-classroom', 'cefr-a1-core'],
  ...
  },
  {
    ...
    sourceModuleReference: {
      ...
      ids: ['grammar-a1-articles-a-an-the', 'reading-a1-my-morning'],
  ...
  },
  {
    ...
    sourceModuleReference: {
      ...
      ids: ['shadow-a1-greeting-friend', 'a1-hello', 'a1-good-morning'],
  ...
  },
  {
    ...
    sourceModuleReference: {
      ...
      ids: ['cefr-a2-core', 'reading-a2-train-trip'],
  ...
  },
  {
    ...
    sourceModuleReference: {
      ...
      ids: ['reading-a2-asking-directions', 'shadow-a2-asking-directions'],
  ...
  },
  {
    ...
    sourceModuleReference: {
      module: 'generated-speech',
      ids: ['b2-learning-strategy', 'b2-career-goals', 'shadow-b2-learning-strategy'],
      runtimeRoute: '/english-speed',
