...
const speechExpansionSeeds: PromptSeed[] = ([
  ...
  ['B1', 'sentence', 'thinking', 'Yet, we need evidence before we choose.', 'Tuy vậy, chúng ta cần bằng chứng trước khi chọn.', ['yet', 'need evidence', 'choose'], ['yet', 'evidence', 'choose']],
  ...
  ['B2', 'sentence', 'work', 'A more sustainable solution would balance cost, quality, and long-term impact.', 'Một giải pháp bền vững hơn sẽ cân bằng chi phí, chất lượng và tác động dài hạn.', ['sustainable solution', 'balance cost', 'long-term impact'], ['sustainable', 'balance', 'impact']],
  ['B2', 'sentence', 'community', 'Although the proposal is ambitious, its benefits remain measurable and realistic.', 'Mặc dù đề xuất tham vọng, lợi ích của nó vẫn đo được và thực tế.', ['although', 'ambitious', 'measurable and realistic'], ['proposal', 'benefits', 'realistic']],
