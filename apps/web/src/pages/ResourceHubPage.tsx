...
import { Box, Button, Flex, HStack, Icon, Input, SimpleGrid, Tag, TagLabel, Text, VStack } from '@chakra-ui/react';
      ...
      <Flex mb="6" p={{ base: '5', md: '7' }} borderRadius="3xl" bgGradient="linear(135deg, #DDF5FF 0%, #E8F4FF 52%, #FFFFFF 100%)" border="1px solid" borderColor="#BAE6FD" boxShadow="0 18px 44px rgba(47, 158, 235, 0.14)" direction={{ base: 'column', md: 'row' }} justify="space-between" gap="4" position="relative" overflow="hidden">
        ...
        <Box position="relative" minW="0">
          <HStack mb="2" gap="2" wrap="wrap">
            <Tag borderRadius="full" bg={COLORS.yellow} color={COLORS.text}>
              <HStack gap="1.5"><Icon as={Waves} boxSize="3.5" /><TagLabel>Kho tài nguyên</TagLabel></HStack>
            </Tag>
        ...
        <Flex align="center" justify="center" minW={{ md: '120px' }} pointerEvents="none">
          <OceanMascot mascot="poo" pose="rest" size="md" decorative motion="float" />
        </Flex>
      </Flex>
