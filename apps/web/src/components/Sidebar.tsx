...
import { Home, BookOpen, Dumbbell, Moon, Sun, Coins, ChevronRight, Waves, LogOut, RefreshCw, Mic, Gamepad2, MessagesSquare, Route } from 'lucide-react';
...
const NAV: NavItem[] = [
  { label: 'Học hôm nay', to: '/luyen-tieng-anh/48-ngay-lay-goc', icon: Waves, tint: OCEAN_TOKENS.whaleBlue, description: 'Bài hôm nay' },
  { label: 'Lộ trình', to: '/learning-path', icon: Route, tint: OCEAN_TOKENS.oceanBlue, description: 'Lộ trình học' },
  ...
  { label: 'Speaking', to: '/speaking-coach', icon: MessagesSquare, tint: OCEAN_TOKENS.oceanBlue, description: 'Poo chấm nói' },
  { label: 'Ôn tập', to: '/practice', icon: Dumbbell, tint: OCEAN_TOKENS.deepBlue, description: 'Câu cần ôn' },
  { label: 'Trò chơi', to: '/games', icon: Gamepad2, tint: OCEAN_TOKENS.whaleBlue, description: 'Luyện phản xạ' },
