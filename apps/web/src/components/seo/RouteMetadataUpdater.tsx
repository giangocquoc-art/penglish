...
const ROUTE_META: Record<string, { title: string; description: string }> = {
  ...
  '/today': {
    title: 'Phiên học tiếng Anh hôm nay cùng PooEnglish',
    description: 'Hoàn thành một phiên học ngắn gồm bài mới, ôn lỗi và luyện nói theo lộ trình Poo đã xếp sẵn.',
  },
  '/speaking-coach': {
