  ...
  return (
    <>
      ...
      <Suspense fallback={<RouteLoadingFallback />}>
        ...
        <Route path="/learning-path/lesson/:unitId/:nodeId" element={<NewShell user={auth.user}><NewInteractiveLessonPage /></NewShell>} />
        <Route path="/learn/:lessonId" element={<NewShell user={auth.user}><NewInteractiveLessonPage /></NewShell>} />
        <Route path="/luyen-tieng-anh/48-ngay-lay-goc" element={<NewShell user={auth.user}><Foundation48Page /></NewShell>} />
        <Route path="/luyen-tieng-anh/48-ngay-lay-goc/ngay/:dayNumber" element={<NewShell user={auth.user}><Foundation48DayPage /></NewShell>} />
