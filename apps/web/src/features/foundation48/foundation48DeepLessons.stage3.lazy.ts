...
const stage3Seeds: Record<number, DaySeed> = {
  13: {
    ...
    grammarTitle: 'Did + subjectừ vựnguyên mẫu?',
    grammar: 'Trong câu hỏi quá khứ đơn với động từ thường, dùng Did ở đầu câu. Sau Did, động từ chính từ vựnguyên mẫu: Did you study? Không nói Did you studied?',
  ...
  14: {
    ...
    grammarTitle: 'did not / didn’từ vựnguyên mẫu',
    ...
    patterns: [['Subject + didn’t + verb', 'Phủ định việc đã không làm', ['I didn’t watch TV.', 'They didn’t play football.']], ['Didn’từ vựnguyên mẫu', 'Không dùng quá khứ sau didn’t', ['He didn’t go.', 'She didn’t finish.']], ['Subject + didn’t + verb + because...', 'Nói lý do đơn giản', ['I didn’t go because I was tired.']]],
  ...
  17: {
    ...
    goal: 'Nói khả năngữ pháp đơn giản và phủ định bằng can/can’t + động từ nguyên mẫu.',
    grammarTitle: 'can / can’từ vựnguyên mẫu',
    ...
    patterns: [['Subject + can + verb', 'Nói ai đó có thể làm gì', ['I can speak English.', 'She can cook well.']], ['Subject + can’t + verb', 'Nói ai đó không thể làm gì', ['He can’t swim.', 'They can’t drive.']], ['Can + subject + verb?', 'Hỏi khả năngữ pháp', ['Can you help me?', 'Can she speak English?']]],
