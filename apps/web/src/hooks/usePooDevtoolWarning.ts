...
import { oceanMascots } from '../lib/p-english/oceanAssets';
...
export function usePooDevtoolWarning() {
  ...
  return createElement(
    ...
    createElement(
      'div',
      { style: { display: 'flex', alignItems: 'center', gap: 10, fontWeight: 950, fontSize: 15, marginBottom: 6 } },
      createElement('img', { src: oceanMascots.poo.poses.happy, alt: '', 'aria-hidden': true, width: 34, height: 34, style: { objectFit: 'contain' } }),
      'Poo thấy bạn mở DevTools rồi nha',
    ),
