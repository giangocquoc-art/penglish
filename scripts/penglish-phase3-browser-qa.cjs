...
const routeChecks = [
  ...
  { name: 'practice-review-center-mobile', route: '/practice', width: 390, height: 844, screenshot: 'phase3-practice-real-review-center-mobile.png', testId: 'practice-mobile-root', text: /Ôn câu Poo nhắc|từ yếu|Bắt đầu ôn/i },
  { name: 'words-notebook-mobile', route: '/words', width: 390, height: 844, screenshot: 'phase3-words-learned-notebook-mobile.png', testId: 'vocab-learned-words-panel', openDetailsTestId: 'vocab-notebook-details', text: /Từ vựng đã lưu từ bài học thật|hello|Yêu thích/i },
  { name: 'shadowing-mobile', route: '/shadowing', width: 390, height: 844, screenshot: 'phase3-shadowing-mobile.png', testId: 'shadowing-hub-page', text: /Shadowing cùng Poo|Luyện tiếp hôm nay|Luyện tiếp/i },
...
async function gotoAndCheck(page, check, errors) {
  ...
  if (check.openDetailsTestId) {
    await page.getByTestId(check.openDetailsTestId).locator(':scope > summary').click();
  }
