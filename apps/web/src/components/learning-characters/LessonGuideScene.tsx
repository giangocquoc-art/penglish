...
import { BookOpen, MessageCircle, Mic2, Play, Sparkles, UserRound, Zap } from 'lucide-react';
...
function WhaleBody({ energetic = false }: { energetic?: boolean }) {
  return (
    ...
    >
      ...
      {energetic ? <Icon className="lesson-guide-spark" as={Zap} position="absolute" right="-4px" top="-2px" boxSize="5" color={GUIDE_COLORS.amber} fill="#FEF3C7" willChange="transform, opacity" aria-hidden="true" /> : null}
    </Box>
  );
}
    ...
    return (
      <Flex align="center" justify="center" gap="3" minH="112px">
        <VStack className="lesson-guide-dialogue-person" gap="1" willChange="transform, opacity">
          <Flex w="54px" h="54px" borderRadius="full" bg={GUIDE_COLORS.softBlue} align="center" justify="center"><Icon as={UserRound} boxSize="7" color={GUIDE_COLORS.deepBlue} strokeWidth="2.3" aria-hidden="true" /></Flex>
        ...
        <VStack className="lesson-guide-dialogue-person" gap="1" willChange="transform, opacity">
          <Flex w="54px" h="54px" borderRadius="full" bg="#F0FDF4" align="center" justify="center"><Icon as={UserRound} boxSize="7" color="#15803D" strokeWidth="2.3" aria-hidden="true" /></Flex>
        ...
        <VStack align="start" gap="2" flex="1" w="100%">
          <HStack wrap="wrap" gap="2" align="center">
            <Tag borderRadius="full" bg={GUIDE_COLORS.softAqua} color={GUIDE_COLORS.deepBlue}>
              <HStack gap="1.5"><Icon as={Sparkles} boxSize="3.5" /><TagLabel>Phiên học có hướng dẫn</TagLabel></HStack>
            </Tag>
