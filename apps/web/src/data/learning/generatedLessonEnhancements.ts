...
export const generatedLessonEnhancements: LessonEnhancementProfile[] = [
  ...
  },
  {
    ...
    confidenceGoalVi: 'Dùng đúng mẫu câu trọng tâm trong bài mà không cần nhớ thuật ngữ pháp.',
  ...
  },
  {
    ...
    levelHints: ['A2'],
    skillHintừ vựng', 'Ôn tập'],
    focus: 'review-memory',
    sourceIds: ['words-cefr-dataset', 'olp-en-cefrj-primary'],
    learnerStrategyVi: 'Chia từ theo tình huống thực tế, ôn mục yếu trước, rồi ghép nghĩa để khóa lộ trìnhớ.',
  ...
  },
  {
    ...
    whaleCoachLineVi: 'Ở B1/B2, mục tiêu không phát âmà là bắt được ý, từ vựng chứng trong bài.',
