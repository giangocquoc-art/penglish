...
import { BookOpen, RefreshCw, Search, Siren } from "lucide-react";
  ...
  return (
    <main id="poo-decoy-page" role="alertdialog" aria-modal="true" aria-labelledby="poo-decoy-title" style={styles.page}>
      ...
      <section style={styles.card}>
        <div style={styles.siren}>
          <Siren size={16} aria-hidden="true" />
          HẢI QUAN ĐẠI DƯƠNG POOENGLISH
          <Siren size={16} aria-hidden="true" />
        </div>

        <div style={styles.radar}>
          <div aria-hidden="true" style={styles.radarLine} />
          <div aria-hidden="true" style={styles.whale}>
            <OceanMascot mascot="poo" pose="coach" size="sm" decorative motion="none" />
          </div>
        </div>
        ...
        <div style={styles.ticket}>
          ...
          <TicketRow label="Tình hình" value="Từ vựng đang bị cá voi Poo theo dõi" />
          <TicketRow label="Hình phạt" value="Nộp phạt từ vựng + 1 câu Shadowing" />
        </div>
