...
export const shadowingLessons: ShadowingLesson[] = [
  lesson({
    ...
    sentences: [
      ...
      { id: 's5', text: 'Let us go to class togetừ vựng ta cùng đến lớp nhé.', hint: 'Đọc class together rõ nhưng chậm.', focusWords: ['class', 'together'] },
    ],
  }),
  lesson({
  ...
  lesson({
    ...
    sentences: [
      ...
      { id: 's5', text: 'We eat dinner togetừ vựng tôi ăn tối cùng nhau.', hint: 'Dinner together nhấn đều hai từ.', focusWords: ['dinner', 'together'] },
  ...
  lesson({
    ...
    sentences: [
      ...
      { id: 's5', text: 'Yes, it is across from the supermarketừ vựng, nó ở đối diện siêu thị.', hint: 'Across from nhấn across.', focusWords: ['across', 'supermarket'] },
  ...
  lesson({
    ...
    sentences: [
      ...
      { id: 's4', text: 'We will have lunch togetừ vựng tôi sẽ ăn trưa cùng nhau.', hint: 'Will have nối nhẹ.', focusWords: ['lunch', 'together'] },
  ...
  lesson({
    ...
    sentences: [
      ...
      { id: 's2', text: 'I practice English for ten minutes every morning.', vi: 'Tôi luyện tiếng Anh mười phát âmỗi sáng.', hint: 'Practice English nối nhẹ.', focusWords: ['practice', 'morning'] },
      ...
      { id: 's5', text: 'But I try again and learn from mistừ vựng tôi thử lại và học từ lỗi sai.', hint: 'Try again nối nhẹ.', focusWords: ['try again', 'mistakes'] },
  ...
  lesson({
    ...
    sentences: [
      ...
      { id: 's2', text: 'The weather was warm and sunny.', vi: 'Thời từ vựng.', hint: 'Weather có âm /th/ hữu thanh.', focusWords: ['weather', 'sunny'] },
      ...
      { id: 's5', text: 'Everything tasted fresh and delicious.', vi: 'Mọi từ vựngon.', hint: 'Delicious nhấn âm hai.', focusWords: ['fresh', 'delicious'] },
      { id: 's6', text: 'It was a simple trip, but I felt happy.', vi: 'Đó là chuyến đi đơn giản nhưng tôi thấy vui.', hint: 'Simplộ trìnhịp rõ.', focusWords: ['simple', 'happy'] },
      { id: 's7', text: 'I hope to go back there one day.', vi: 'từ vựngày nào đó sẽ quay lại.', hint: 'Go back there nối nhẹ.', focusWords: ['hope', 'go back'] },
    ],
  }),
];
