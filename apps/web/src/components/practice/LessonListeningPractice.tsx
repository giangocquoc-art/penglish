    ...
    return (
      <Box bg={COLORS.bg} minH="calc(100vh - 72px)" px="6" py="8">
        <Box maxW="760px" mx="auto" bg="white" border="1px solid" borderColor={COLORS.border} borderRadius="3xl">
          <PooSystemState variant="empty" title="Poo chưa có câu nghe cho bài này" description="Bài này đang ưu tiên nhịp luyện khác. Bạn quay lại bài học để chọn phần đang sẵn sàng nhé." actionLabel="Quay về bài học" actionTo={`/lessons/${lesson.id}`} />
        </Box>
      </Box>
    );
  }
