...
const SHADOWING_WORKFLOW_STEPS = ['Chọn bài', 'Nghe/xem tham khảo', 'Nghe câu', 'Ghi âm', 'Dừng ghi âm', 'Poo góp ý'];
      ...
      <Box maxW="1180px" mx="auto" minW="0" pb={{ base: '128px', lg: '0' }}>
        <Flex data-testid="shadowing-hero" className="shadowing-hero penglish-glass-card" mb={{ base: '2', md: '5' }} p={{ base: '3', md: '6' }} borderRadius="3xl" bg="rgba(255,255,255,0.78)" border="1px solid" borderColor="#BAE6FD" boxShadow="0 14px 34px rgba(31, 111, 214, 0.07)" direction={{ base: 'column', lg: 'row' }} justify="space-between" gap={{ base: '2', md: '5' }} position="relative" overflow="hidden" willChange="transform, opacity" backdropFilter="blur(14px) saturate(1.1)">
          ...
          <Box position="relative" minW="0" flex="1">
            ...
            <Text mt={{ base: '1.5', md: '3' }} color={COLORS.muted} maxW="800px" fontSize={{ base: 'sm', md: 'md' }} fontWeight="700" lineHeight={{ base: '1.4', md: '1.7' }} noOfLines={{ base: 3, md: undefined }}>Chọn bài → Nghe/xem tham khảo → Nghe câu → Ghi âm. Poo chấm phát âm, nhịp và từ còn thiếu.</Text>
        ...
        <SimpleGrid columns={{ base: 1, lg: 12 }} gap={{ base: '3', md: '5' }} minW="0" alignItems="start">
                ...
                <Box data-testid="shadowing-recording-card" p={{ base: '3', md: '4' }} borderRadius="2xl" bg="rgba(248,252,255,0.78)" border="1px solid" borderColor="#BAE6FD" scrollMarginBottom="calc(var(--penglish-mobile-safe-bottom) + 112px)">
                  <HStack mb="3" justify="space-between" align="start" gap="3" wrap="wrap">
                    <Box>
                      ...
                      <Text mt="1" fontSize="sm" color={COLORS.muted} noOfLines={{ base: 2, md: undefined }}>Bấm ghi âm, đọc theo transcript, rồi dừng để nhận AI feedback.</Text>
                    </Box>
                    <Chip tone="amber">AI feedback</Chip>
                  </HStack>
                  ...
                  <Text mt="3" fontSize="sm" color={COLORS.muted} role="status" aria-live="polite" display={{ base: isAnalyzing ? 'block' : 'none', md: 'block' }}>{isAnalyzing ? 'Poo đang nghe và phân tích giọng nói...' : 'Poo sẽ nghe bản ghi và góp ý phát âm, nhịp, từ thiếu hoặc từ lệch.'}</Text>
                </Box>
              </SimpleGrid>
            </Box>
          ...
          <VStack align="stretch" gap={{ base: '3', md: '4' }} minW="0" gridColumn={{ lg: 'span 4' }} pb={{ base: '96px', lg: '0' }}>
            ...
            <Box data-testid="shadowing-custom-transcript" as="details" open={typeof window !== 'undefined' ? window.innerWidth >= 1024 : true} className="shadowing-custom-card penglish-glass-card" p="4" borderRadius="3xl" bg="rgba(248,252,255,0.78)" border="1px solid" borderColor={COLORS.border} boxShadow="0 10px 24px rgba(16, 42, 67, 0.04)" backdropFilter="blur(14px) saturate(1.1)">
              <Box as="summary" cursor="pointer" fontWeight="950" color={COLORS.text}>Tự tạo transcript</Box>
