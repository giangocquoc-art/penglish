...
export const pEnglishLessons: EnglishLesson[] = [
  {
    ...
    unitTitle: 'Bài 1 — Chào hỏi và giới thiệu bản thân',
    ...
    speakingReflexPrompts: [
      { id: 'reflex-hello-im-nam', promptVi: 'Poo thử thách nhẹ: nói ‘Xin chào, mình là Nam.’', expectedEnglish: 'Hello, I’m Nam.', acceptableAnswers: ['Hello, I’m Nam.', 'Hi, I’m Nam.'], hint: 'Bắt đầu bằng Hello hoặc Hi, sau đó nói I’m Nam.', difficulty: 'easy' },
      { id: 'reflex-whats-your-name', promptVi: 'Giúp Poo hỏi: ‘Bạn tên gì?’', expectedEnglish: 'What’s your name?', acceptableAnswers: ['What’s your name?', 'What is your name?'], hint: 'Dùng câu hỏi What’s your name?', difficulty: 'easy' },
      { id: 'reflex-my-name-is-lan', promptVi: 'Poo thử thách nhẹ: nói ‘Tên mình là Lan.’', expectedEnglish: 'My name is Lan.', acceptableAnswers: ['My name is Lan.', 'I’m Lan.'], hint: 'Dùng My name is...', difficulty: 'easy' },
      { id: 'reflex-nice-to-meet-you', promptVi: 'Poo thử thách nhẹ: nói ‘Rất vui được gặp bạn.’', expectedEnglish: 'Nice to meet you.', acceptableAnswers: ['Nice to meet you.', 'It’s nice to meet you.'], hint: 'Nói cả cụm Nice to meet you.', difficulty: 'easy' },
      { id: 'reflex-nice-too', promptVi: 'Poo thử thách nhẹ: nói ‘Mình cũng rất vui được gặp bạn.’', expectedEnglish: 'Nice to meet you too.', acceptableAnswers: ['Nice to meet you too.', 'Nice to meet you, too.'], hint: 'Thêm too ở cuối câu.', difficulty: 'easy' },
      { id: 'reflex-where-from', promptVi: 'Giúp Poo hỏi: ‘Bạn đến từ đâu?’', expectedEnglish: 'Where are you from?', acceptableAnswers: ['Where are you from?', 'Where do you come from?'], hint: 'Câu hỏi chính trong bài bắt đầu bằng Where are...', difficulty: 'medium' },
      { id: 'reflex-im-from-vietnam', promptVi: 'Poo thử thách nhẹ: nói ‘Mình đến từ Việt Nam.’', expectedEnglish: 'I’m from Vietnam.', acceptableAnswers: ['I’m from Vietnam.', 'I am from Vietnam.'], hint: 'Dùng I’m from...', difficulty: 'easy' },
      { id: 'reflex-im-a-student', promptVi: 'Poo thử thách nhẹ: nói ‘Mình là học sinh/sinh viên.’', expectedEnglish: 'I’m a student.', acceptableAnswers: ['I’m a student.', 'I am a student.'], hint: 'Nhớ dùng a trước student.', difficulty: 'easy' },
    ],
    ...
    quizQuestions: [
      ...
      },
      {
        ...
        answer: 'Cảm ơn',
        explanationVi: 'Đúng rồi, “Thank you” là cách nói cảm ơn lịch sự và rất dễ dùng.',
      },
    ],
    ...
    commonMistakes: [
      { id: 'unit-1-mistake-i-am-vs-my-name', mistake: 'Nói “I am name Nam.”', correction: 'Nói “I am Nam.” hoặc “My name is Nam.”', explanationVi: 'Hai mẫu này không trộn được: “I am + tên” hoặc “My name is + tên”. Chọn một mẫu và giữ nguyên.' },
      { id: 'unit-1-mistake-how-are-you-answer', mistake: 'Trả lời “How are you?” bằng “I am fine, thanks you.”', correction: 'Nói “I’m fine, thank you.”', explanationVi: '“thank you” là hai từ riêng; “thanks” đứng một mình. Đừng ghép thành “thanks you”.' },
      { id: 'unit-1-mistake-nice-to-meet-you-tense', mistake: 'Nói “Nice to meet you” khi gặp lại người đã biết.', correction: 'Gặp lại thì nói “Nice to see you again.”', explanationVi: '“meet” dùng cho lần đầu gặp; “see again” dùng cho lần gặp lại.' },
    ],
    realLifeSituations: [
      { id: 'unit-1-situation-first-meeting', title: 'Gặp một người mới', scenarioVi: 'Bạn gặp một người mới trong lớp. Hãy chào, nói tên, hỏi tên và nói nơi mình đến từ.', usefulPhrases: ['Hello, I’m Nam.', 'What’s your name?', 'Nice to meet you.', 'I’m from Vietnam.'] },
    ],
    reviewRules: {
      ...
      priorityRule: 'Ưu tiên luyện các cụm trước từ đơn lẻ.',
    },
    completionCriteria: {
  ...
  },
  {
    ...
    unitTitle: 'Bài nghe A1 — Gặp bạn mới trong lớp',
    titleVi: 'Gặp bạn mới trong lớp',
    ...
    miniDialogues: [
      ...
      {
        id: 'a1-classmate-dialogue-role-swap',
        title: 'Đổi vai: giúp một bạn mới',
        lines: [
          { speaker: 'A', text: 'Hi. Are you new here?' },
          { speaker: 'B', text: 'Yes. Is this seat free?' },
          { speaker: 'A', text: 'Yes, you can sit here. Open your book to page ten.' },
          { speaker: 'B', text: 'Thank you. We have pair work today.' },
        ],
        vietnameseTranslation: ['A: Chào bạn. Bạn mới ở đây à?', 'B: Đúng vậy. Chỗ này còn trống không?', 'A: Có, bạn có thể ngồi đây. Mở sách đến trang mười nhé.', 'B: Cảm ơn. Hôm nay chúng ta làm việc theo cặp.'],
        focusPhrases: ['Are you new here?', 'Is this seat free?', 'Open your book to page ten.', 'pair work'],
        suggestedShadowingInstruction: 'Đổi vai sau mỗi lượt: một lần làm bạn mới, một lần làm người hướng dẫn trong lớp.',
      },
    ],
    grammarNotes: [
    ...
    listeningPractice: [
      { id: 'a1-classmate-listen-new', text: 'Hi, I am new here.', question: 'What does the speaker say?', options: ['I am new here.', 'I am from here.', 'I am not here.', 'I am a teacher.'], answer: 'I am new here.', explanationVi: 'Đúng rồi, “new here” cho Poo biết người nói mới đến nơi này.', speechSynthesis: { lang: 'en-US', rate: 0.86, repeatRecommended: 3 } },
    ...
    speakingReflexPrompts: [
      { id: 'a1-classmate-reflex-new', promptVi: 'Poo thử thách nhẹ: nói ‘Mình mới ở đây.’', expectedEnglish: 'I am new here.', acceptableAnswers: ['I am new here.', 'I’m new here.'], hint: 'Dùng new here.', difficulty: 'easy' },
      { id: 'a1-classmate-reflex-seat-free', promptVi: 'Giúp Poo hỏi: ‘Chỗ này còn trống không?’', expectedEnglish: 'Is this seat free?', acceptableAnswers: ['Is this seat free?'], hint: 'Bắt đầu bằng Is this...', difficulty: 'easy' },
      { id: 'a1-classmate-reflex-sit-here', promptVi: 'Poo thử thách nhẹ: nói ‘Bạn có thể ngồi ở đây.’', expectedEnglish: 'You can sit here.', acceptableAnswers: ['You can sit here.'], hint: 'You can + động từ.', difficulty: 'easy' },
      { id: 'a1-classmate-reflex-open-book', promptVi: 'Poo thử thách nhẹ: nói ‘Mở sách của bạn.’', expectedEnglish: 'Open your book.', acceptableAnswers: ['Open your book.', 'Please open your book.'], hint: 'Open your book.', difficulty: 'easy' },
      { id: 'a1-classmate-reflex-see-you', promptVi: 'Poo thử thách nhẹ: nói ‘Hẹn gặp lại sau.’', expectedEnglish: 'See you later.', acceptableAnswers: ['See you later.'], hint: 'Cụm chào tạm biệt.', difficulty: 'easy' },
    ],
    ...
    quizQuestions: [
      { id: 'a1-classmate-quiz-seat', type: 'multiple-choice', question: '“Is this seat free?” nghĩa là gì?', options: ['Chỗ này còn trống không?', 'Bạn tên gì?', 'Mở sách ra.', 'Hẹn gặp lại.'], answer: 'Chỗ này còn trống không?', explanationVi: 'Đúng rồi, trong câu này seat là chỗ ngồi, free là còn trống.' },
    ...
    commonMistakes: [
      { id: 'a1-classmate-mistake-seat-sit', mistake: 'Nhầm seat và sit khi nghe.', correction: 'seat = chỗ ngồi; sit = ngồi.', explanationVi: 'Hãy nghe âm dài /iː/ trong “seat” và âm ngắn trong “sit”.' },
      { id: 'a1-classmate-mistake-name-question', mistake: 'Nghe “What is your name?” nhưng chỉ bắt được từ name rồi đoán sai người đang được hỏi.', correction: 'Nghe cả cụm “your name” để biết người nói đang hỏi tên của bạn.', explanationVi: 'Từ sở hữu your/my giúp xác định đúng người trong hội thoại giới thiệu.' },
      { id: 'a1-classmate-mistake-first-listen', mistake: 'Cố dịch từng từ ngay ở lượt nghe đầu.', correction: 'Lượt đầu chỉ bắt ý: hai bạn đang chào hỏi và làm quen.', explanationVi: 'Nghe ý chính trước giúp bạn không bị hụt khi gặp một từ chưa biết.' },
    ],
    realLifeSituations: [
      { id: 'a1-classmate-situation-class', title: 'Ngày đầu vào lớp', scenarioVi: 'Bạn vào lớp mới và cần hỏi chỗ ngồi còn trống.', usefulPhrases: ['I am new here.', 'Is this seat free?', 'You can sit here.'] },
      { id: 'a1-classmate-situation-role-swap', title: 'Giúp một bạn mới', scenarioVi: 'Một bạn mới ngồi cạnh bạn. Hãy xác nhận chỗ trống, chỉ trang sách và bắt đầu làm việc theo cặp.', usefulPhrases: ['Are you new here?', 'You can sit here.', 'Open your book to page ten.', 'We have pair work today.'] },
    ],
    ...
    reviewRules: { newWordReviewAfterMinutes: 10, ifWrong: 'Nếu sai câu nghe, phát lại ở tốc độ chậm và hiện lời thoại sau khi chọn đáp án.', ifCorrectTwice: 'Nếu đúng 2 lần, chuyển sang phản xạ nói câu đó.', ifCorrectThreeTimesAcrossSessions: 'Nếu đúng 3 phiên, đưa cụm vào nhóm đã quen.', priorityRule: 'Ưu tiên cụm giao tiếp lớp học trước từ đơn.' },
  ...
  },
  {
    ...
    unitId: 'a1-listening-everyday',
    unitTitle: 'Bài nghe A1 — Gọi đồ uống đơn giản',
    titleVi: 'Gọi đồ uống đơn giản',
    ...
    miniDialogues: [
      { id: 'a1-drink-dialogue-main', title: 'Gọi đồ uống', lines: [{ speaker: 'A', text: 'Hello. Can I see the menu?' }, { speaker: 'B', text: 'Yes. Here you are.' }, { speaker: 'A', text: 'One small coffee, please.' }, { speaker: 'B', text: 'Sure. Anything else?' }, { speaker: 'A', text: 'Cold water, please. How much is it?' }, { speaker: 'B', text: 'It is three dollars.' }], vietnameseTranslation: ['A: Xin chào. Mình xem thực đơn được không?', 'B: Vâng. Của bạn đây.', 'A: Cho mình một ly cà phê nhỏ nhé.', 'B: Được chứ. Còn gì nữa không?', 'A: Cho mình nước lạnh nhé. Món này bao nhiêu tiền vậy?', 'B: Ba đô la.'], focusPhrases: ['Can I see the menu?', 'One small coffee, please.', 'Cold water, please.', 'How much is it?'], suggestedShadowingInstruction: 'Lặp câu gọi món với nhịp lịch sự; nhấn nhẹ vào đồ uống và kích cỡ.' },
      { id: 'a1-drink-dialogue-change-order', title: 'Đổi món và kích cỡ', lines: [{ speaker: 'A', text: 'Can I have a large tea, please?' }, { speaker: 'B', text: 'Sure. Anything else?' }, { speaker: 'A', text: 'Cold water, please. How much is it?' }, { speaker: 'B', text: 'It is four dollars. Here you are.' }], vietnameseTranslation: ['A: Cho mình một ly trà lớn nhé.', 'B: Được chứ. Còn gì nữa không?', 'A: Cho mình nước lạnh nhé. Tổng cộng bao nhiêu tiền vậy?', 'B: Bốn đô la. Của bạn đây.'], focusPhrases: ['a large tea', 'Anything else?', 'Cold water, please.', 'How much is it?'], suggestedShadowingInstruction: 'Đổi tea thành coffee hoặc orange juice, rồi đổi small/large để tạo lượt gọi món mới.' },
    ],
    ...
    speakingReflexPrompts: [
      { id: 'a1-drink-reflex-menu', promptVi: 'Giúp Poo hỏi: ‘Mình xem thực đơn được không?’', expectedEnglish: 'Can I see the menu?', acceptableAnswers: ['Can I see the menu?', 'May I see the menu?'], hint: 'Can I see...', difficulty: 'easy' },
      { id: 'a1-drink-reflex-coffee', promptVi: 'Thử gọi món cùng Poo: ‘Cho mình một ly cà phê nhỏ nhé.’', expectedEnglish: 'One small coffee, please.', acceptableAnswers: ['One small coffee, please.', 'A small coffee, please.'], hint: 'small coffee, please.', difficulty: 'easy' },
      { id: 'a1-drink-reflex-water', promptVi: 'Thử gọi món cùng Poo: ‘Cho mình nước lạnh nhé.’', expectedEnglish: 'Cold water, please.', acceptableAnswers: ['Cold water, please.'], hint: 'Cold water...', difficulty: 'easy' },
      { id: 'a1-drink-reflex-price', promptVi: 'Giúp Poo hỏi: ‘Món này bao nhiêu tiền vậy?’', expectedEnglish: 'How much is it?', acceptableAnswers: ['How much is it?'], hint: 'How much...', difficulty: 'easy' },
      { id: 'a1-drink-reflex-here-you-are', promptVi: 'Poo thử thách nhẹ: nói ‘Của bạn đây.’', expectedEnglish: 'Here you are.', acceptableAnswers: ['Here you are.'], hint: 'Cụm phục vụ lịch sự.', difficulty: 'easy' },
    ],
    ...
    quizQuestions: [
      { id: 'a1-drink-quiz-menu', type: 'multiple-choice', question: '“menu” nghĩa là gì?', options: ['thực đơn', 'chỗ ngồi', 'trang sách', 'bạn cùng lớp'], answer: 'thực đơn', explanationVi: 'Đúng rồi, menu là thực đơn ở quán hoặc cửa hàng.' },
      { id: 'a1-drink-quiz-order', type: 'sentence-order', vietnamese: 'Cho mình một ly cà phê nhỏ nhé.', words: ['One', 'small', 'coffee', 'please'], answer: 'One small coffee please', explanationVi: 'Đúng rồi, mình xếp số lượng, kích cỡ, đồ uống rồi thêm please cho lịch sự nhé.' },
      { id: 'a1-drink-quiz-price', type: 'multiple-choice', question: '“How much is it?” dùng để hỏi gì?', options: ['giá tiền', 'tên', 'chỗ ngồi', 'trang sách'], answer: 'giá tiền', explanationVi: 'Đúng rồi, How much...? là cách hỏi giá rất quen thuộc.' },
    ...
    sentenceOrderingTasks: [{ id: 'a1-drink-order-coffee', vietnamese: 'Cho mình một ly cà phê nhỏ nhé.', words: ['One', 'small', 'coffee', 'please'], answer: 'One small coffee please' }, { id: 'a1-drink-order-price', vietnamese: 'Món này bao nhiêu tiền vậy?', words: ['How', 'much', 'is', 'it'], answer: 'How much is it' }],
    ...
    englishSpeedPrompts: [{ id: 'a1-drink-speed-coffee', promptVi: 'Cho mình một ly cà phê nhỏ nhé.', expectedEnglish: 'One small coffee, please.', hint: 'One small...' }, { id: 'a1-drink-speed-price', promptVi: 'Món này bao nhiêu tiền vậy?', expectedEnglish: 'How much is it?', hint: 'How much...' }],
    shadowingScript: { id: 'a1-drink-shadow', title: 'Nói đuổi: gọi đồ uống', lines: [{ id: 'a1-drink-shadow-1', text: 'Can I see the menu?', meaningVi: 'Mình xem thực đơn được không?' }, { id: 'a1-drink-shadow-2', text: 'One small coffee, please.', meaningVi: 'Cho mình một ly cà phê nhỏ nhé.' }, { id: 'a1-drink-shadow-3', text: 'How much is it?', meaningVi: 'Món này bao nhiêu tiền vậy?' }] },
    commonMistakes: [
      { id: 'a1-drink-mistake-please', mistake: 'Quên “please” khi gọi món.', correction: 'Thêm please ở cuối câu.', explanationVi: 'Ở tình huống dịch vụ, please giúp câu lịch sự và tự nhiên hơn.' },
      { id: 'a1-drink-mistake-want-would-like', mistake: 'Dùng “I want...” với giọng quá trực tiếp khi gọi đồ uống.', correction: 'Dùng “I’d like...” hoặc “Can I have...?” để gọi món lịch sự.', explanationVi: 'Cả hai mẫu đều ngắn, tự nhiên và phù hợp trong quán.' },
      { id: 'a1-drink-mistake-size', mistake: 'Bỏ sót từ chỉ cỡ hoặc số lượng khi nghe.', correction: 'Nghe cụm danh từ đầy đủ như “a small coffee” hoặc “two waters”.', explanationVi: 'Từ chỉ cỡ/số lượng thay đổi món người nói muốn gọi nên không thể bỏ qua.' },
    ],
    realLifeSituations: [
      { id: 'a1-drink-situation-cafe', title: 'Gọi đồ ở quán nước', scenarioVi: 'Bạn muốn xem thực đơn, gọi cà phê nhỏ và hỏi giá.', usefulPhrases: ['Can I see the menu?', 'One small coffee, please.', 'How much is it?'] },
      { id: 'a1-drink-situation-change-order', title: 'Đổi món hoặc kích cỡ', scenarioVi: 'Quán hết cà phê nhỏ. Hãy đổi sang trà lớn, gọi thêm nước lạnh và hỏi tổng giá.', usefulPhrases: ['A large tea, please.', 'Cold water, please.', 'Anything else?', 'How much is it?'] },
    ],
    gameMissions: [{ id: 'a1-drink-mission-listen', title: 'Bắt tên đồ uống và giá', instructionVi: 'Nghe mỗi câu trước khi xem lời thoại, tập trung vào tên đồ uống/kích cỡ/giá.', successCriteria: 'Trả lời đúng ít nhất 4/5 câu nghe.' }],
  ...
  },
  {
    ...
    unitTitle: 'Bài 2 — Gia đình và bạn bè',
    ...
    sentencePatterns: [
      ...
      { id: 'u2-pattern-age', pattern: 'My + person + is + number + years old.', vietnameseExplanation: 'Dùng để nói tuổi. Bài 2 chỉ luyện vài số quen thuộc, không biến thành bài học số đếm.', examples: [{ text: 'My sister is eight years old.', meaningVi: 'Chị/em gái tôi tám tuổi.' }, { text: 'My brother is ten years old.', meaningVi: 'Anh/em trai tôi mười tuổi.' }] },
    ],
    miniDialogues: [
      { id: 'u2-dialogue-introducing-friend', title: 'Giới thiệu bạn', lines: [{ speaker: 'A', text: 'Hi, I’m Lan.' }, { speaker: 'B', text: 'Hi, Lan. Who is this?' }, { speaker: 'A', text: 'This is my friend, Mai.' }, { speaker: 'B', text: 'Nice to meet you, Mai.' }, { speaker: 'A', text: 'Nice to meet you too.' }], vietnameseTranslation: ['A: Chào, mình là Lan.', 'B: Chào Lan. Đây là ai?', 'A: Đây là bạn mình, Mai.', 'B: Rất vui được gặp bạn, Mai.', 'A: Mình cũng rất vui được gặp bạn.'], focusPhrases: ['Who is this?', 'This is my friend, ...', 'Nice to meet you'], suggestedShadowingInstruction: 'Lặp lại từng câu 3 lần, nối mượt từ Bài 1 “Hi, I’m...” sang “This is my friend...”.' },
    ...
    speakingReflexPrompts: [
      { id: 'u2-reflex-this-is-my-mother', promptVi: 'Poo thử thách nhẹ: nói ‘Đây là mẹ của tôi.’', expectedEnglish: 'This is my mother.', acceptableAnswers: ['This is my mother.', 'This is my mom.'], hint: 'Dùng This is my...', difficulty: 'easy' },
      { id: 'u2-reflex-who-is-this', promptVi: 'Giúp Poo hỏi: ‘Đây là ai?’', expectedEnglish: 'Who is this?', acceptableAnswers: ['Who is this?', 'Who’s this?'], hint: 'Bắt đầu bằng Who.', difficulty: 'easy' },
      { id: 'u2-reflex-this-is-my-friend', promptVi: 'Poo thử thách nhẹ: nói ‘Đây là bạn của tôi, Mai.’', expectedEnglish: 'This is my friend, Mai.', acceptableAnswers: ['This is my friend, Mai.', 'This is my friend Mai.'], hint: 'This is my friend + tên.', difficulty: 'easy' },
      { id: 'u2-reflex-her-name-is-linh', promptVi: 'Poo thử thách nhẹ: nói ‘Tên của cô ấy là Linh.’', expectedEnglish: 'Her name is Linh.', acceptableAnswers: ['Her name is Linh.'], hint: 'Dùng Her name is...', difficulty: 'medium' },
      { id: 'u2-reflex-his-name-is-minh', promptVi: 'Poo thử thách nhẹ: nói ‘Tên của anh ấy là Minh.’', expectedEnglish: 'His name is Minh.', acceptableAnswers: ['His name is Minh.'], hint: 'Dùng His name is...', difficulty: 'medium' },
      { id: 'u2-reflex-my-mom-kind', promptVi: 'Poo thử thách nhẹ: nói ‘Mẹ tôi tốt bụng.’', expectedEnglish: 'My mom is kind.', acceptableAnswers: ['My mom is kind.', 'My mother is kind.'], hint: 'My mom is + tính từ.', difficulty: 'easy' },
      { id: 'u2-reflex-brother-age', promptVi: 'Poo thử thách nhẹ: nói ‘Anh/em trai tôi mười tuổi.’', expectedEnglish: 'My brother is ten years old.', acceptableAnswers: ['My brother is ten years old.'], hint: 'Dùng years old ở cuối câu.', difficulty: 'medium' },
    ...
    quizQuestions: [
      ...
      { id: 'u2-quiz-match-friend', type: 'match-meaning', question: 'Ghép nghĩa đúng.', pairs: [{ left: 'best friend', right: 'bạn thân' }, { left: 'classmate', right: 'bạn cùng lớp' }], options: ['bạn thân', 'bạn cùng lớp', 'mẹ', 'ông'], answer: ['best friend = bạn thân', 'classmate = bạn cùng lớp'], explanationVi: 'Đây là các từ mô tả bạn bè trong Bài 2.' },
      { id: 'u2-quiz-do-you-have', type: 'multiple-choice', question: 'Câu nào dùng để hỏi “Bạn có anh/em trai không?”', options: ['Do you have a brother?', 'This is my brother.', 'His name is Minh.', 'My brother is ten.'], answer: 'Do you have a brother?', explanationVi: 'Do you have...? là cụm hỏi có/không.' },
    ],
    sentenceOrderingTasks: [
    ...
    fillBlankTasks: [
      ...
      { id: 'u2-blank-do-you-have', prompt: 'Do you ___ a brother?', answer: 'have', hint: 'Dùng cụm Do you have...?' },
    ],
    reviewRules: {
      newWordReviewAfterMinutes: 10,
      ifWrong: 'Nếu trả lời sai, ưu tiên hiển thị lại các cụm “This is my...”, “his/her name is...” trong cùng phiên.',
      ifCorrectTwice: 'Nếu trả lời đúng 2 lần, đánh dấu từ/cụm là quen thuộc.',
      ifCorrectThreeTimesAcrossSessions: 'Nếu trả lời đúng 3 lần qua nhiều phiên, đánh dấu là đã học.',
      priorityRule: 'Ưu tiên luyện cụm giới thiệu người thân/bạn bè trước khi mở rộng tính từ mô tả.',
    },
    commonMistakes: [
      { id: 'unit-2-mistake-this-is-my-vs-i-have', mistake: 'Nói “I have a mother” khi muốn giới thiệu.', correction: 'Nói “This is my mother.” khi chỉ người; “I have a brother.” khi nói số lượng.', explanationVi: 'Giới thiệu người dùng “This is my + người.” Khi muốn nói mình có bao nhiêu người thân thì mới dùng “have”.' },
      { id: 'unit-2-mistake-he-she-confusion', mistake: 'Nói “This is he.” khi giới thiệu mẹ hoặc bạn gái.', correction: 'Nói “This is she.” cho người nữ, “This is he.” cho người nam.', explanationVi: '“he” = người nam, “she” = người nữ. Nhìn người trước khi chọn đại từ.' },
      { id: 'unit-2-mistake-his-her-swap', mistake: 'Nói “Her name is Tom.” (người nam).', correction: 'Dùng “His name is Tom.” cho người nam; “Her name is Linh.” cho người nữ.', explanationVi: '“his” đi với người nam, “her” đi với người nữ. Nhớ tính từ sở hữu gắn với giới tính người được nói đến.' },
    ],
    completionCriteria: {
  ...
  },
  {
    ...
    unitTitle: 'Bài 3 — Trường học và lớp học',
    ...
    sentencePatterns: [
      ...
      { id: 'u3-pattern-need-homework', pattern: 'I need to do my homework.', vietnameseExplanation: 'Dùng “need to + verb” để nói điều cần làm. Ở Bài 3 chỉ cần nhớ cụm này.', examples: [{ text: 'I need to do my homework.', meaningVi: 'Tôi cần làm bài tập về nhà.' }, { text: 'I need to study for the test.', meaningVi: 'Tôi cần học cho bài kiểm tra.' }] },
    ...
    grammarNotes: [
      { id: 'u3-grammar-this-is', title: 'This is... để giới thiệu đồ vật/nơi chốn', explanationVi: 'Dùng “This is...” để nói “Đây là...”. Ở Bài 3, dùng với classroom, desk, board, notebook.', examples: ['This is my classroom.', 'This is my desk.'] },
      ...
      { id: 'u3-grammar-need-to', title: 'need to + động từ', explanationVi: '“I need to do...” nghĩa là “Tôi cần làm...”. Bài 3 tập trung vào “I need to do my homework”.', examples: ['I need to do my homework.', 'I need to study for the test.'] },
    ],
    pronunciationNotes: [
    ...
    speakingReflexPrompts: [
      { id: 'u3-reflex-this-classroom', promptVi: 'Poo thử thách nhẹ: nói ‘Đây là lớp học của tôi.’', expectedEnglish: 'This is my classroom.', acceptableAnswers: ['This is my classroom.', 'This is our classroom.'], hint: 'Dùng This is my...', difficulty: 'easy' },
      { id: 'u3-reflex-english-monday', promptVi: 'Poo thử thách nhẹ: nói ‘Tôi có môn tiếng Anh vào thứ Hai.’', expectedEnglish: 'I have English on Monday.', acceptableAnswers: ['I have English on Monday.'], hint: 'I have + subject + on + day.', difficulty: 'medium' },
      { id: 'u3-reflex-where-notebook', promptVi: 'Giúp Poo hỏi: ‘Vở của bạn ở đâu?’', expectedEnglish: 'Where is your notebook?', acceptableAnswers: ['Where is your notebook?', 'Where’s your notebook?'], hint: 'Bắt đầu bằng Where is...', difficulty: 'easy' },
      ...
      { id: 'u3-reflex-help-question', promptVi: 'Poo thử thách nhẹ: nói ‘Bạn có thể giúp mình câu hỏi này không?’', expectedEnglish: 'Can you help me with this question?', acceptableAnswers: ['Can you help me with this question?'], hint: 'Can you help me with...', difficulty: 'medium' },
      { id: 'u3-reflex-homework', promptVi: 'Poo thử thách nhẹ: nói ‘Tôi cần làm bài tập về nhà.’', expectedEnglish: 'I need to do my homework.', acceptableAnswers: ['I need to do my homework.', 'I have to do my homework.'], hint: 'I need to do...', difficulty: 'easy' },
      { id: 'u3-reflex-look-board', promptVi: 'Poo thử thách nhẹ: nói ‘Hãy nhìn lên bảng.’', expectedEnglish: 'Look at the board.', acceptableAnswers: ['Look at the board.', 'Please look at the board.'], hint: 'Look at...', difficulty: 'easy' },
    ...
    quizQuestions: [
      ...
      { id: 'u3-quiz-look-board', type: 'multiple-choice', question: '“Look at the board.” nghĩa là gì?', options: ['Hãy nhìn lên bảng.', 'Hãy mở cặp sách.', 'Hãy làm bài tập.', 'Hãy đến thư viện.'], answer: 'Hãy nhìn lên bảng.', explanationVi: 'Đúng rồi, board là chiếc bảng mình thường thấy trong lớp học.' },
    ],
    sentenceOrderingTasks: [
    ...
    realLifeSituations: [
      { id: 'unit-3-situation-class-help', title: 'Nhờ giúp trong giờ học', scenarioVi: 'Bạn không tìm thấy vở, cần mượn bút chì và muốn nhờ bạn giải thích một câu hỏi.', usefulPhrases: ['Where is my notebook?', 'Can I borrow your pencil?', 'Can you help me with this question?', 'Thank you.'] },
    ],
    reviewRules: {
      newWordReviewAfterMinutes: 10,
      ...
      ifCorrectTwice: 'Nếu trả lời đúng 2 lần, đánh dấu từ/cụm là quen thuộc.',
      ifCorrectThreeTimesAcrossSessions: 'Nếu trả lời đúng 3 lần qua nhiều phiên, đánh dấu là đã học.',
      priorityRule: 'Ưu tiên cụm giao tiếp lớp học như “Can I borrow...?” và “Can you help me...?” trước khi mở rộng thêm môn học.',
    },
    commonMistakes: [
      { id: 'unit-3-mistake-borrow-vs-lend', mistake: 'Nói “Can I lend your pencil?”', correction: 'Nói “Can I borrow your pencil?”', explanationVi: '“borrow” = mượn (mình lấy về), “lend” = cho mượn (mình đưa đi). Khi xin thì luôn dùng “borrow”.' },
      { id: 'unit-3-mistake-homework-plural', mistake: 'Nói “I have many homeworks.”', correction: 'Nói “I have a lot of homework.”', explanationVi: '“homework” là danh từ không đếm được, không thêm “s” và không dùng “many”.' },
      { id: 'unit-3-mistake-subject-vs-object', mistake: 'Nói “My favorite object is English.”', correction: 'Nói “My favorite subject is English.”', explanationVi: '“subject” = môn học; “object” = đồ vật. Hai từ này khác nghĩa hoàn toàn.' },
    ],
    completionCriteria: {
      flashcardsReviewed: 20,
      minimumQuizCorrect: 8,
