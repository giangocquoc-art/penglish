  ...
  return (
    <Box bg="linear-gradient(180deg, rgba(232,244,255,0.74), rgba(248,252,255,0.95))" minH="calc(100vh - 68px)" px={{ base: '3', md: '5' }} py={{ base: '4', md: '7' }}>
      <Container maxW="760px" px="0">
        <Box textAlign="center" bg="rgba(255,255,255,0.88)" border="1px solid" borderColor="rgba(186,230,253,0.86)" borderRadius="3xl" boxShadow="0 24px 70px rgba(31,111,214,0.12)" overflow="hidden">
          <PooSystemState
            variant="error"
            headingAs="h1"
            mascotSize="lg"
            title="Bài viết này bơi lạc rồi"
            description="Poo chưa tìm thấy bài viết bạn muốn đọc. Bạn quay lại blog để chọn một chủ đề khác nhé."
            actionLabel="Về blog PooEnglish"
            actionTo="/blog"
          />
        </Box>
      </Container>
