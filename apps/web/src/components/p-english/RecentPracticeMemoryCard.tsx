      ...
      <HStack position="relative" justify="space-between" align="start" gap="4">
        <Box minW="0">
          <HStack gap="2" mb="2" wrap="wrap">
            <Tag borderRadius="full" bg={COLORS.yellow} color={COLORS.text} fontWeight="900">
              <HStack gap="1.5"><Icon as={Waves} boxSize="3.5" /><Text as="span">Trí nhớ luyện tập</Text></HStack>
            </Tag>
          ...
          <Box p="4" borderRadius="2xl" bg="rgba(255,255,255,0.72)" border="1px solid" borderColor="rgba(186,230,253,0.84)">
            ...
            {topSkill ? (
              <Text mt="2" color={COLORS.deepBlue} fontSize="sm" fontWeight="900">
                Kỹ năng gần nhất: {SKILL_LABELS[topSkill[0]]} · {topSkill[1].averagePercentage}%
              </Text>
            ) : null}
          </Box>
        </VStack>
