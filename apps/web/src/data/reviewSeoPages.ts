...
const universalFaqs: ReviewSeoFaq[] = [
  ...
  },
  {
    ...
    answer: 'Người mới nên bắt đầu với 15–25 phút. Quan trọng nhất là duy trì nhịp đều: một ít từ vựng, một ít nghe nói, một bài ôn ngắn và một ghi chú lỗi sai cần quay lại.',
  },
  {
  ...
  return [
    {
      ...
      paragraphs: [
        `${keyword} không nên được hiểu là ngồi học lại thật nhiều lý thuyết trong một buổi. Với người mới, ôn hiệu quả là gặp lại kiến thức cũ trong bối cảnh vừa đủ dễ hiểu, rồi dùng nó thêm một lần nữa. Nếu hôm qua bạn học một câu giới thiệu bản thân, hôm nay bạn có thể nghe lại câu đó, đổi một từ trong câu, nói lại theo nhịp chậm và làm một câu kiểm tra nhỏ. Cách ôn như vậy khiến não nhận ra tiếng Anh là thứ đang được dùng, không phải một danh sách nằm yên trong vở.`,
        `PooEnglish nhìn việc ôn như một vòng bơi nhỏ: nhặt lại từ quen, nhìn câu mẫu, nghe âm, nói theo, kiểm tra và đánh dấu phần còn yếu. Vòng này không quá nặng nên người học bận rộn vẫn có thể quay lại mỗi ngày. Cá voi Poo không cổ vũ kiểu học thật gấp rồi kiệt sức; Poo thích nhịp đều, mềm và có dấu hiệu tiến bộ rõ ràng. Khi bạn ôn ít nhưng đúng chỗ, cảm giác sợ tiếng Anh sẽ giảm dần.`,
        `Điểm quan trọng của ${keyword} là biết mình đang ôn để làm gì. Có ngày mục tiêu là nhớ từ, có ngày là nghe ra âm nối, có ngày là nói một câu bớt ngập ngừng. Nếu gom tất cả mục tiêu vào cùng lúc, người mới dễ nản. Vì vậy Poo khuyên bạn chọn một trọng tâm chính cho mỗi buổi, ví dụ hôm nay tập trung vào ${focus}, ngày mai quay sang nghe hoặc nói. Sự rõ ràng giúp buổi ôn ngắn nhưng có kết quả.`,
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        ...
        `Với trọng tâm ${focus}, bạn vẫn nên giữ một chút liên kết sang kỹ năng khác. Ví dụ ôn từ vựng thì đọc câu ví dụ thành tiếng; ôn ngữ pháp thì nghe một câu có mẫu đó; ôn nghe thì ghi lại từ khóa; ôn nói thì xem lại một cấu trúc đơn giản. Poo gọi đây là cách bơi theo cụm sóng: không quá rộng, nhưng đủ để kỹ năng này đẩy kỹ năng kia tiến lên.`,
      ],
    },
    {
      ...
      paragraphs: [
        ...
        `Trong ứng dụng, bạn có thể đi theo lộ trình, mở phòng shadowing để nói theo câu ngắn, dùng sổ từ vựng để ôn lại phần cần nhớ và quay lại các trang hướng dẫn khi muốn hiểu phương pháp. Các liên kết này không phải để bạn mở hết cùng lúc. Hãy chọn một điểm bắt đầu. Nếu mất gốc, vào lộ trình. Nếu ngại nói, thử shadowing. Nếu hay quên từ, mở sổ từ. Mỗi lựa chọn đều có thể trở thành một bước nhỏ trong cùng hành trình.`,
        `Một điểm Poo muốn nhắc là ôn tập không phải hình phạt cho việc bạn quên. Quên là cơ chế bình thường của trí nhớ. Việc ôn chỉ là cách gửi lại tín hiệu cho não rằng kiến thức này vẫn quan trọng. Khi bạn gặp lại một câu sau vài ngày và nhớ nhanh hơn lần trước, đó là tiến bộ thật. Đừng chỉ đo bằng số bài đã học; hãy đo bằng cảm giác hiểu nhanh hơn, nghe rõ hơn và dám nói thêm một câu.`,
      ],
    },
    {
...
export const REVIEW_SEO_PAGES: ReviewSeoPage[] = [
  {
    ...
    title: 'Ôn tiếng Anh cho người mới bắt đầu - PooEnglish',
    description: 'Hướng dẫn ôn tiếng Anh hiệu quả cùng PooEnglish: từ vựng, ngữ pháp, luyện nghe, shadowing và lộ trình học rõ ràng cho người mới bắt đầu.',
    h1: 'Ôn tiếng Anh cho người mới bắt đầu cùng PooEnglish',
    eyebrow: 'Cụm từ khóa ôn tiếng Anh',
    quickAnswer: 'Ôn tiếng Anh hiệu quả là ôn theo vòng nhỏ mỗi ngày: xem lại từ vựng, hiểu mẫu câu, nghe câu ngắn, nói theo và ghi lại lỗi sai. Người mới không cần học quá nhiều; hãy bắt đầu 15–25 phút với một mục tiêu rõ ràng và quay lại đều.',
    sections: learningLoop('ôn tiếng Anh', 'xây lại nền tổng hợp'),
    faqs: [
      ...universalFaqs,
      { question: 'Ôn tiếng Anh nên bắt đầu từ kỹ năng nào?', answer: 'Nếu bạn chưa chắc nền, hãy bắt đầu từ từ vựng và câu mẫu ngắn, sau đó thêm nghe và nói theo. Đừng tách kỹ năng quá lâu, vì tiếng Anh cần được dùng trong câu thật.' },
      ...
      { question: 'PooEnglish có giúp ôn đều mỗi ngày không?', answer: 'Có. Bạn có thể dùng lộ trình, shadowing và sổ từ vựng để tạo một vòng học ngắn, dễ quay lại mà không bị quá tải.' },
    ],
  ...
  },
  {
    ...
    title: 'Ôn tiếng Anh cho người mất gốc - Bắt đầu lại cùng PooEnglish',
    ...
    faqs: [
      ...universalFaqs,
      { question: 'Mất gốc có nên học ngữ pháp lại từ đầu không?', answer: 'Nên học, nhưng học qua mẫu câu trước. Bạn không cần đọc quá nhiều thuật ngữ; hãy hiểu một mẫu nhỏ và dùng nó trong câu đời thường.' },
      { question: 'Bao lâu thì người mất gốc thấy tiến bộ?', answer: 'Nếu học đều 15–25 phút mỗi ngày, bạn có thể cảm thấy quen câu và bớt sợ sau vài tuần. Tiến bộ ban đầu thường là hiểu nhanh hơn và dám nói câu ngắn.' },
  ...
  },
  {
    ...
    description: 'Gợi ý cách ôn tiếng Anh hiệu quả mỗi ngày cho người mới: chia nhỏ mục tiêu, ôn đúng lỗi sai, kết hợp từ vựng, nghe, nói, shadowing và ngữ pháp.',
    h1: 'Cách ôn tiếng Anh hiệu quả mỗi ngày mà không bị quá tải',
    eyebrow: 'Phương pháp học đều',
    ...
    faqs: [
      ...universalFaqs,
      { question: 'Ôn tiếng Anh buổi sáng hay buổi tối tốt hơn?', answer: 'Thời điểm tốt nhất là thời điểm bạn duy trì được. Buổi sáng hợp để khởi động nhẹ, buổi tối hợp để xem lại lỗi sai và nghe câu ngắn.' },
  ...
  },
  {
    ...
    keyword: 'ôn từ vựng tiếng Anh',
    title: 'Ôn từ vựng tiếng Anh dễ nhớ cùng PooEnglish',
    description: 'Hướng dẫn ôn từ vựng tiếng Anh theo ngữ cảnh, câu ví dụ, nhịp lặp lại và sổ từ vựng để người mới nhớ lâu hơn mà không học vẹt.',
    h1: 'Ôn từ vựng tiếng Anh dễ nhớ bằng câu và ngữ cảnh',
    eyebrow: 'Nhặt vỏ sò từ vựng',
    quickAnswer: 'Ôn từ vựng hiệu quả không phải học thật nhiều từ rời rạc. Hãy học từ trong câu, nghe cách phát âm, tự đặt một ví dụ ngắn và quay lại từ đó sau vài ngày.',
    sections: learningLoop('ôn từ vựng tiếng Anh', 'ghi nhớ từ trong ngữ cảnh'),
    faqs: [
      ...universalFaqs,
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: 'Nên nghe giọng bản xứ hay giọng chậm?', answer: 'Người mới nên bắt đầu với giọng rõ và tốc độ vừa phải. Khi tai quen hơn, bạn tăng dần tốc độ và độ dài.' },
      { question: 'Luyện nghe có cần nói theo không?', answer: 'Rất nên. Nói theo giúp tai và miệng phối hợp, từ đó bạn nhớ nhịp câu tốt hơn.' },
    ],
  ...
  },
  {
    ...
    faqs: [
      ...universalFaqs,
      { question: 'Phát âm chưa tốt có nên luyện nói không?', answer: 'Nên. Bạn cần nói để phát hiện âm khó. Hãy luyện chậm, nghe lại mẫu và sửa từng chút.' },
  ...
  },
  {
    ...
    description: 'Cách ôn shadowing tiếng Anh mỗi ngày bằng đoạn ngắn, nghe mẫu, nói đuổi, sửa nhịp và kết hợp từ vựng để luyện phản xạ tự nhiên hơn.',
  ...
  },
  {
    ...
    h1: 'Học tiếng Anh mỗi ngày cùng cá voi Poo bằng bước nhỏ dễ giữ',
    eyebrow: 'Thói quen học đều',
    quickAnswer: 'Học tiếng Anh mỗi ngày không cần quá dài. Bạn chỉ cần một vòng học nhỏ gồm ôn từ, nghe một câu, nói lại, làm quiz ngắn và ghi một lỗi sai. Nhịp đều quan trọng hơn cường độ cao.',
  ...
  },
  {
    ...
    sections: learningLoop('luyện tiếng Anh online', 'học linh hoạt với lộ trình và công cụ ôn tập'),
    faqs: [
      ...universalFaqs,
